                    ...
                    <div className="space-y-8 text-[#555] leading-relaxed">
                        ...
                        <section>
                            ...
                            <ul className="space-y-4 list-disc pl-5">
                                <li>
                                    <strong>Photos:</strong> When you use StickerMe, you upload a photo of yourself. This photo is sent to our AI service solely to generate your sticker pack. We do not store, sell, or use your photo for any other purpose. Your photo is automatically deleted after sticker generation is complete.
                                </li>
                                <li>
                        ...
                        <section>
                            ...
                            <p className="mb-4">We work with the following trusted partners to deliver our service:</p>
                            <ul className="space-y-3 list-disc pl-5">
                                <li><strong>OpenAI:</strong> Processes your uploaded photo to generate AI sticker images. <a href="https://openai.com/policies/privacy-policy" className="underline text-[#222]" target="_blank" rel="noopener noreferrer">OpenAI Privacy Policy</a></li>
